...
(function($) {
    ...
    var queryCondition = function(me, query, fn, fn2) {
    ...
    $.extend($.fn, {
        livequery: function(fn, fn2) {
            ...
            $.each( $jQlq.queries, function(i, query) {
                if (queryCondition(me, query, fn, fn2)) {
        ...
        expire: function(fn, fn2) {
            ...
            $.each( $jQlq.queries, function(i, query) {
                if (queryCondition(me, query, fn, fn2) && !me.stopped) {
                    $jQlq.stop(query.id);
                }
            });
    ...
    $jQlq.prototype = {
        ...
        run: function() {
            ...
            var oEls = me.elements,
                els, newEls, delEls,
                tr = function() {
                    els = $(me.context).find(me.selector);
                    newEls = els.not(oEls);
                    delEls = oEls.not(els);
                };
            ...
            try {
                ...
                try {
                    ...
                    console.log('Error running livequery. 2 attempts.', me, e);
                    return;
                }
            }
